...
# Trim the old file changes block at the end (from line 2261)
trimmed_lines = lines[:2261]

new_content = """  - 將 `LITTLE_TRAVELER` (小旅人) Token 的 `image` 路由由先前誤設定的「尋寶小旅人」卡圖 `/static/card_images/c_nms_0071.jpeg` 還原回森林區小旅人的正確專用卡圖 `/static/little_traveler.jpeg`，完美修復了博物館接待員召喚的小旅人圖卡錯誤問題。
...
print("Updated walkthrough.md successfully with Receptionist details!")
