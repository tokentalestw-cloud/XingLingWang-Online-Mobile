...
for idx, line in enumerate(lines):
    if 'data.zone' in line or 'data.toZone' in line or 'data.fromZone' in line:
...
with open(r'c:\Users\a2132\Documents\星靈王\XingLingWang_v7_fixed\scratch\ws_zones.txt', 'w', encoding='utf-8') as f_out:
    f_out.write('\n'.join(output_lines))
