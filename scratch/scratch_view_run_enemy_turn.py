...
for idx, line in enumerate(lines, 1):
    if "async function runEnemyTurn" in line or "function runEnemyTurn" in line:
        found = True
...
if found:
    out_path = os.path.join(base_dir, "scratch/runEnemyTurn_code.txt")
    with open(out_path, "w", encoding="utf-8") as f_out:
        f_out.writelines(output_lines)
    print("Done. Saved to scratch/runEnemyTurn_code.txt")
else:
    print("runEnemyTurn not found")
