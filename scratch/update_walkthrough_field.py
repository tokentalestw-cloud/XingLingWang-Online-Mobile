...
# Trim the old file changes block at the end (from line 2258)
trimmed_lines = lines[:2258]

new_content = """  - 新增 `populateLobbyDecksDropdown()` 函式，由選中的種族 (`#factionSelect`) 動態過濾並填入對應的牌組 (`#deckSelect`)，使大廳大槽位顯示極致清爽。
...
print("Updated walkthrough.md successfully with Field Magic details!")
