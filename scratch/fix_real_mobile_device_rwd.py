...
def fix_real_mobile_rwd():
    ...
    real_mobile_css = """/* ==========================================================================
   REAL MOBILE DEVICE LANDSCAPE RWD (實體手機與 PWA 滿版絕不疊加 100% 全貌對齊)
   ========================================================================== */
...
@media (max-width: 1024px) {
  ...
  /* 1. 最上排工具列 (Top Bar) 0.46 大幅精確縮放，手機橫向 100% 完全收納，絕不安突出 */
  .topbar-grouped-v9 {
  ...
  /* 2. 對戰棋盤大幅向上拉升 -55px，40% 縮放完全置中，敵我雙方區域與手牌 100% 全全呈現 */
  .board-wrap {
    width: 100% !important;
...
"""
    ...
    print("1. Updated static/style_v8.css with real mobile device landscape RWD CSS successfully!")

    # Update cache-buster in static/index.html to v=15.10-real-mobile-landscape-rwd
    idx_path = 'static/index.html'
    idx_content = open(idx_path, encoding='utf-8').read()
    idx_content = re.sub(r'game_v8\.js\?v=[^"\']+', 'game_v8.js?v=15.10-real-mobile-landscape-rwd', idx_content)
    idx_content = re.sub(r'style_v8\.css\?v=[^"\']+', 'style_v8.css?v=15.10-real-mobile-landscape-rwd', idx_content)
